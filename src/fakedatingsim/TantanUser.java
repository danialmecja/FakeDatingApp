...
public class TantanUser implements Serializable {
    ...
    public static TantanUser currentFriendZoneUser = new TantanUser();

    public TantanUser(String username, String password, String firstName, String lastName, int age, String gender, ArrayList<String> interest, String city) {
    ...
    public TantanUser (String currentUser, String currentPass) {
...
//        validatePassword(input.nextLine()); Still needs work. Method is located below saveProfile()
    ...
    public void choiceToSave (TantanUser signUp) throws IOException {
        ...
        try
        {
            ...
            while ((lineNumber = br.readLine()) != null)
            {
                ...
                if (username.equals(tempUsername) && password.equals(tempPassword))
                {
                    ...
                    currentFriendZoneUser = new TantanUser(username, password);
    ...
    public void saveProfile(TantanUser signUp) throws IOException {
